...
//{
//    public abstract class MultiTenant_Creation_Tests<TStartupModule> : CosmosDBTestBase
...
//            var person = await _personRepository.FindAsync(personId.ToString(), TestDataBuilder.LastName).ConfigureAwait(false);
